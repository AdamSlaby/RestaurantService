...
public class Restaurant {
    ...
    @Digits(integer = 4, fraction = 2, message = "Podana opłata za dwoóz jest nieprawidłowa")
    ...
    @Digits(integer = 5, fraction = 2, message = "Podana minimalna cena dostawy jest nieprawidłowa")
